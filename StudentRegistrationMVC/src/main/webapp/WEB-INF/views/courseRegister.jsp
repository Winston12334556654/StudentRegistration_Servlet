...
<body>
    ...
    <div class="sidenav">
        ...
        <button class="dropdown-btn" > Class Management <i class="fa fa-caret-down"></i></button>
          ...
          <a href="../../../../../../../../Downloads/Student%20Registration%20/STU001.html">Student Registration </a>
          <a href="../../../../../../../../Downloads/Student%20Registration%20/STU003.html">Student Search </a>
        </div>
        <a href="../../../../../../../../Downloads/Student%20Registration%20/USR003.html">Users Management</a>
      </div>
      <div class="main_contents">
    <div id="sub_content">
        <form action="courseRegistrate" method="post">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <input type="text" class="form-control" name="courseId" id="id" value="${courseId}">
            </div>
        </div>
